...
if __name__ == '__main__':
    # Default to eierOS Gerrit
    default_gerrit = 'https://review.eieros.net'
    ...
    for item in mergables:
        ...
        if args.gerrit == default_gerrit:
            ...
            if args.pull:
                cmd = ['git pull --no-edit eier', item['fetch'][method]['ref']]
            else:
                cmd = ['git fetch eier', item['fetch'][method]['ref']]
            if args.quiet:
                cmd.append('--quiet')
            else:
                print(cmd)
