...
custom_default_revision = "eier-12.1"
custom_dependencies = "eier.dependencies"
org_manifest = "eierOS-Devices"  # leave empty if org is provided in manifest
org_display = "eierOS-Devices"  # needed for displaying

eier_manifest = ".repo/manifests/eier.xml"
...
def add_to_manifest(repos, fallback_branch=None):
    ...
    eierm = load_manifest(eier_manifest)
    ...
    for repo in repos:
        ...
        elif exists_in_tree(eierm, repo_target) != None:
            existing_m_project = exists_in_tree(eierm, repo_target)
